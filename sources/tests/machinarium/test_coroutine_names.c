...
static inline void test_coro_names(void *arg)
{
	...
	test(cname != NULL);
	test(strcmp(cname, "") == 0);
	cname = machine_coroutine_get_name(coro3);
	test(cname != NULL);
	test(strcmp(cname, "a") == 0);
	cname = machine_coroutine_get_name(coro4);
	test(cname != NULL);
	test(strcmp(cname, "ab") == 0);
	cname = machine_coroutine_get_name(coro5);
	test(cname != NULL);
	test(strcmp(cname, "abcdef") == 0);
	cname = machine_coroutine_get_name(coro6);
	test(cname != NULL);
	test(strcmp(cname, "abcdefghqwerty") == 0);
	cname = machine_coroutine_get_name(coro7);
	test(cname != NULL);
	test(strcmp(cname, "abcdefghqwertyi") == 0);
	cname = machine_coroutine_get_name(coro8);
	test(cname != NULL);
	test(strcmp(cname, "abcdefghqwertyi") == 0);
	cname = machine_coroutine_get_name(coro9);
	test(cname != NULL);
	test(strcmp(cname, "abcdefghqwertyi") == 0);
	cname = machine_coroutine_get_name(coro10);
	test(cname != NULL);
	test(strcmp(cname, "abcdefghqwertyi") == 0);
